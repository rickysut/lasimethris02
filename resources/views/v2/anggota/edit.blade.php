			...
			<div class="panel-container show">
				<form method="POST" action=" {{ route('admin.task.anggotapoktan.update', $anggota->id) }} "
					...
					<div class="panel-content">
						<input type="text" value="{{$anggota->master_kelompok_id}}" id="master_kelompok_id" name="master_kelompok_id" hidden>
						<div class="col-12 mb-3">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control " id="nama_petani" name="nama_petani" placeholder="contoh: Ahmad Sobari" value="{{ old('nama_petani', $anggota->nama_petani) }}" required>
								</div>
						...
						<div class="col-12 mb-3">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control " id="nik_petani" name="nik_petani" placeholder="contoh: 3101012205890001" value="{{ old('nik_petani', $anggota->nik_petani) }}" required>
								</div>
								<div class="help-block">
						...
						<div class="col-12 mb-3">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="number" step="0.01" class="form-control " id="luas_lahan" name="luas_lahan" value="{{ old('luas_lahan', $anggota->luas_lahan) }}" required>
								</div>
								<div class="help-block">
						...
						<div class="col-12 mb-3">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control " id="periode_tanam" name="periode_tanam" placeholder="contoh: Jan-Feb" value="{{ old('periode_tanam', $anggota->periode_tanam) }}">
								</div>
								<div class="help-block">
					...
					<div class="panel-content card-footer">
						<div class="d-flex justify-content-end">
							<div></div>
							<div>
								<a href="{{ route('admin.task.masterpoktan.listanggota', $anggota->master_kelompok_id) }}" class="btn btn-warning btn-sm">
