	...
	<div class="col-12">
		<div class="panel" id="panel-1">
			...
			<div class="panel-container show">
				<form action="{{ route('admin.task.masterpoktan.update', $masterkelompok->id) }}" method="post">
					@method('PUT')
					@csrf
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control " 
											...
											value="{{ old('nama_kelompok', $masterkelompok->nama_kelompok)}}"
											required>
									</div>
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control "
											...
											value="{{old('nama_pimpinan', $masterkelompok->nama_pimpinan)}}"
											required>
									</div>
									<div class="help-block">
										Nama Pimpinan.
							...
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control "
											id="hp_pimpinan" name="hp_pimpinan"
											value="{{old('hp_pimpinan', $masterkelompok->hp_pimpinan)}}"
											required>
									</div>
									<div class="help-block">
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										name="provinsi_id" id="provinsi_id" required>
											<option value="{{ isset($masterkelompok) ? $masterkelompok->provinsi->provinsi_id : '' }}">
												{{ isset($masterkelompok) ? $masterkelompok->provinsi->provinsi_id. '. ' .  $masterkelompok->provinsi->nama   : 'Load Record' }}
											</option>
										</select>
									</div>
									<div class="help-block">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<select class="select2-kab form-control" id="kabupaten_id" name="kabupaten_id" required>
											<option value="{{ isset($masterkelompok) ? $masterkelompok->kabupaten->kabupaten_id : '' }}">
												{{ isset($masterkelompok) ? $masterkelompok->kabupaten->kabupaten_id. '. ' . 
												$masterkelompok->kabupaten->nama_kab   : 'Load Record' }}
											</option>
										</select>
									</div>
									<div class="help-block">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<select class="select2-kec form-control" id="kecamatan_id" name="kecamatan_id" required>
											<option value="{{ isset($masterkelompok) ? $masterkelompok->kecamatan_id : '' }}">
												{{ isset($masterkelompok) ? $masterkelompok->kecamatan_id. '. ' . 
												$masterkelompok->kecamatan->nama_kecamatan   : 'Load Record' }}
											</option>
										</select>
									</div>
									<div class="help-block">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<select class="select2-des form-control" name="kelurahan_id" id="kelurahan_id" required>
											<option value="{{ isset($masterkelompok) ? $masterkelompok->kelurahan_id : '' }}">
												{{ isset($masterkelompok) ? $masterkelompok->kelurahan_id. '. ' . 
												$masterkelompok->desa->nama_desa  : 'Load Record' }}
											</option>
										</select>
									</div>
									<div class="help-block">
...
<script>
	$(document).ready(function() {
		...
		$.get('/api/getAllProvinsi/', function(data) {
			...
			$provinsiSelect.val('{{ isset($masterkelompok) ? $masterkelompok->provinsi->provinsi_id : '' }}');
		});
	});
</script>
