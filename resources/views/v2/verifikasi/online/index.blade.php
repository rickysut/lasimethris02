				...
				<div class="tab-content py-3">
									...
									<table id="dataPengajuan" class="table table-sm table-bordered table-striped w-100">
										...
										<tbody>
											@foreach ($pengajuans as $pengajuan)
												@if ($pengajuan->onlinestatus === null)
													<tr>
					...
					<div class="tab-pane" id="verified" role="tabpanel">
						<div class="panel" id="panel-2">
							<div class="panel-container show">
								<div class="panel-content">
									<table id="tblVerified" class="table table-sm table-bordered table-striped w-100">
										<thead>
											<th>No. Pengajuan</th>
											<th>No. RIPH</th>
											<th>Tanggal Pengajuan</th>
													...
													<tr>
														...
														<td class="text-center">
															@if($pengajuan->onlinestatus === '1')
																<span class="badge btn-xs btn-success">
																	<i class="fa fa-check mr-1"></i>Selesai
																</span>
															@elseif ($pengajuan->onlinestatus === '2')
																<span class="badge btn-xs btn-danger">
																	<i class="fa fa-exclamation-circle mr-1"></i>Perbaikan
																</span>
															@endif
														</td>
														<td class="text-center">
