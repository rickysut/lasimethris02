...
<div class="row">
    <div class="col">
        <div class="panel" id="panel-2">
            ...
            <form method="POST" action="{{route('admin.task.pks.update', [$pks->id] )}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="panel-content">
                        <div class="row d-flex">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="no_perjanjian" name="no_perjanjian"
                                            required value="{{ $pks->no_perjanjian }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-daterange input-group" id="tgl_perjanjian_start" name="tgl_perjanjian_start">
                                        ...
                                        <input type="date" name="tgl_perjanjian_start" id="tgl_perjanjian_start"
                                            ...
                                            aria-describedby="helpId"  value="{{ $pks->tgl_perjanjian_start }}">
                                    </div>
                                    <div class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-daterange input-group" id="tgl_perjanjian_end" name="tgl_perjanjian_end">
                                        ...
                                        <input type="date" name="tgl_perjanjian_end" id="tgl_perjanjian_end"
                                            ...
                                            aria-describedby="helpId"  value="{{ $pks->tgl_perjanjian_end }}">
                                    </div>
                                    <div class="help-block">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control " name="luas_rencana" id="luas_rencana"   value="{{ $pks->luas_rencana }}">
                                    </div>
                                    <div class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " name="varietas_tanam" id="varietas_tanam"
                                            placeholder="varietas yang akan ditanam"  value="{{ $pks->varietas_tanam }}">
                                    </div>
                                    <div class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="periode_tanam" id="periode_tanam"
                                            class="form-control " placeholder="misal: Jan-Feb" aria-describedby="helpId"  value="{{ $pks->periode_tanam }}">
                                    </div>
                                    <div class="help-block">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-2 mt-2">
                                    <a href="{{ url($pks->berkas_pks) }}" target="_blank" rel="noopener noreferrer" >Lihat berkas yang sudah di upload</a>
                                </div>
                                <div class="input-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="berkas_pks"></label>
                                    </div>
                                </div>
                                <div class="help-block">Unggah pemindaian berkas Form-5 dalam bentuk pdf.</div>
                            </div>
                        </div>
                    </div>
                </div>
