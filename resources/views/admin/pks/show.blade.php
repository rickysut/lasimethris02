                        ...
                        <div class="row d-flex">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="no_perjanjian" name="no_perjanjian"
                                            required readonly value="{{ $pks->no_perjanjian }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-daterange input-group" id="tgl_perjanjian_start" name="tgl_perjanjian_start">
                                        ...
                                        <input type="date" name="tgl_perjanjian_start" id="tgl_perjanjian_start"
                                            ...
                                            aria-describedby="helpId" readonly value="{{ $pks->tgl_perjanjian_start }}">
                                    </div>
                                    <div class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-daterange input-group" id="tgl_perjanjian_end" name="tgl_perjanjian_end">
                                        ...
                                        <input type="date" name="tgl_perjanjian_end" id="tgl_perjanjian_end"
                                            ...
                                            aria-describedby="helpId" readonly value="{{ $pks->tgl_perjanjian_end }}">
                                    </div>
                                    <div class="help-block">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control " name="luas_rencana" id="luas_rencana"  readonly value="{{ $pks->luas_rencana }}">
                                    </div>
                                    <div class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " name="varietas_tanam" id="varietas_tanam"
                                            placeholder="varietas yang akan ditanam"  readonly value="{{ $pks->varietas_tanam }}">
                                    </div>
                                    <div class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="periode_tanam" id="periode_tanam"
                                            class="form-control " placeholder="misal: Jan-Feb" aria-describedby="helpId"  readonly value="{{ $pks->periode_tanam }}">
                                    </div>
                                    <div class="help-block">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select id="province" class="select2-prov form-control w-100" name="provinsi" required disabled>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select id="kabupaten" class="select2-kab form-control w-100" name="kabupaten" required disabled>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select id="kecamatan" class="select2-kec form-control w-100" name="kecamatan" required disabled>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select id="desa" class="select2-des form-control w-100" name="desa" required disabled>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Berkas PKS (Perjanjian Kerjasama)</label>
                                <div class="input-group">
                                    <a href="{{ url($pks->berkas_pks) }}" target="_blank" rel="noopener noreferrer" class="btn btn-xm btn-primary">Lihat berkas</a>
                                    {{-- <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupPrepend3">PKS</span>
                                    </div> --}}

                                    <div class="custom-file">
                                        {{-- <input type="text" class="custom-file-input" id="berkas_pks"  name="berkas_pks" required> --}}
                                        {{-- <label class="custom-file-label" for="berkas_pks">{{ $pks-> }}</label> --}}
                                    </div>
                                </div>
                                <div class="help-block">Pemindaian berkas Form-5 dalam bentuk pdf.</div>
                            </div>
                        </div>
                    </div>
                </div>
